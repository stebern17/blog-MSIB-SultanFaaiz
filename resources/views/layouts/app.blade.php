            ...
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between">
                    <ul class="flex space-x-4 text-white">
                        ...
                        <li>
                            <a href="{{ route('profiles.index') }}" class="hover:text-gray-400">Profile</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
            ...
            <button type="button" onclick="this.parentElement.style.display='none';" class="absolute top-0 bottom-0 right-0 px-4 py-3">
                <svg class="fill-current h-6 w-6 text-green-500" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <path d="M14.348 14.849a1 1 0 001.415 0l.086-.086a1 1 0 000-1.415L10.414 10l4.435-4.435a1 1 0 00-1.415-1.415L9 8.586l-4.435-4.435a1 1 0 00-1.415 1.415L7.586 10l-4.435 4.435a1 1 0 001.415 1.415L9 11.414l4.435 4.435c.39.39 1.024.39 1.415 0z" />
                </svg>
            </button>
        </div>
